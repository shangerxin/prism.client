...
class ScriptRepository(BaseModel):
    ...
    scripts: Optional[List[Script]] = Field(default=None, alias="Scripts")
    __properties: ClassVar[List[str]] = ["id", "name", "url", "Scripts"]
...
ScriptRepository.model_rebuild(raise_errors=False)
