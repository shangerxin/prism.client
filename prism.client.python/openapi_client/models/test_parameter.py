...
class TestParameter(BaseModel):
    ...
    data: Optional[object] = Field(default=None, alias="data")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TestParameter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TestParameter from a dict"""
        if obj is None:
            return None
